...
// STK-G0-22 — estado explícito da policy de importação automática (v3, casas
// explícitas: aprovadas e pendentes).
//
...
export function readAutomaticPolicy(): {
  ...
  try {
    ...
    const parsed = automaticPolicyV3Schema.safeParse(JSON.parse(readFileSync(path, 'utf8')));
