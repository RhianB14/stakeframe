...
- [x] 6. Testes: recusa sem 200 falso, PATCH idêntico aceito, casa canônica
      ...
      entrega Telegram
- [ ] 7. Bateria completa (typecheck/lint/unit/integração/e2e desktop+mobile/
      build/api:spec:check/format/diff-check/OpenSpec strict) e diff-review
- [ ] 8. Devolutiva na PR + card em REVIEW
