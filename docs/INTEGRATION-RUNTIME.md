...
> pela STK-M0-41 em 11/09/2026**; **reativado, com validação operacional,
...
> IA (cota/custo) como condições permanentes. O runtime local aguarda o
> migrador; produção segue seu runbook de migração prévia.
