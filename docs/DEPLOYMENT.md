...
- Serviços: aplicação web, API, worker, PostgreSQL 18 e Caddy (proxy HTTPS),
  ...
  Gemini diretamente, conforme [AI-MODEL-SELECTION.md](AI-MODEL-SELECTION.md).
...
contínua com Gemini, Telegram e R2 ainda não faz parte deste Compose. A instalação
